...
--Firing related
SWEP.Primary.Sound 			= Sound("Anaconda.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_anaconda.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_anaconda.mdl" -- same case UHGI;DFSD/
...
SWEP.IronSightsPos = Vector(5.155, -2, 1.76)
SWEP.IronSightsAng = Vector(5.2, 0.1, -0.1)
