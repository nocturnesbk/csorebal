...
SWEP.Author				= "★Bullet★, Kamikaze, modified by stxrgzr" --Author Tooltip
...
--Firing related
SWEP.Primary.Sound 			= Sound("AUG.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_aug.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_aug.mdl" -- same case UHGI;DFSD/
...
SWEP.IronSightsPos = Vector(8.9, -4.76, 1.2)
SWEP.IronSightsAng = Vector(-1, 1.5, 11)
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_aug")
