...
self.Charge = math.Clamp(self.Charge + 0,0,15)
        self.Primary_TFA.Sound = "BALROG3.Fire"
...
self.Charge = math.Clamp(self.Charge + 1,0,16)
if self.Charge == 16 then

self:SetClip1(self:Clip1()+1)  
if self.Owner:GetAmmoCount( "smg1" ) > 0 then
        self.Owner:SetAmmo( self.Owner:GetAmmoCount( "smg1" ) - 1, "smg1")
		self.Weapon:SendWeaponAnim(ACT_VM_PULLBACK)
        self.Primary_TFA.Sound = "BALROG3.Fire2"
		...
		self.MuzzleFlashEffect = "tfa_muzzleflash_smg"
		self.Primary_TFA.ImpactEffect = "exp_balrog"
		self:ClearStatCache()
end
