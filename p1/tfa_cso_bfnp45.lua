...
SWEP.PrintName				= "Battle FNP-45"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Spread		= .0048					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .0024	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_bfnp45.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_bfnp45.mdl" -- Worldmodel path
...
SWEP.IronSightsAng = Vector(1, -0.03, -0.4)
...
SWEP.BlowbackAngle = Angle(-2, 0, 0)
...
SWEP.BlowbackBoneMods = {
	["Bone25"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 60, 0) },
	["Bone16"] = { scale = Vector(1, 1, 1), pos = Vector(-1.42, 0.62, 0), angle = Angle(0, 0, 0) },
}
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_bfnp45")
