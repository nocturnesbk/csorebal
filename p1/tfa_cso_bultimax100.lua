...
SWEP.PrintName				= "Battle Ultimax 100"		-- Weapon name (Shown on HUD)
...
--Recoil Related
SWEP.Primary.KickUp			= 0.070					-- This is the maximum upwards recoil (rise)
SWEP.Primary.KickDown			= 0.070					-- This is the maximum downwards recoil (skeet)
...
SWEP.Primary.Spread		= .0034					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .00170	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_bultimax100.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_bultimax100.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_bultimax100")
