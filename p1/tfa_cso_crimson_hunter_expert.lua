--[[
sighhhh have to restrict this one
goodbye, my dearest deagle lmfaooo
]]--
...
SWEP.Secondary.Ammo = "Blood Grenade"
...
if SERVER then
if self.NextGen > 11 and self:Ammo2() < 1 then
self.Owner:GiveAmmo( 1,self.Secondary.Ammo, true )
self:EmitSound("CrimsonHunter.Change")
self.NextGen  = 0
end
