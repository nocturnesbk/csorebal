--what even is this???
--oh after testing its just a reskin m3 dragon cannon
--restricted 
...
SWEP.PrintName				= "Eruptor"		-- Weapon name (Shown on HUD)
...
SWEP.ProjectileDamage = 1750

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_eruptor.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_eruptor.mdl" -- Weapon world model path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_eruptor")
