-- ohhh it's the fidget spinner grenade thing.
-- gonna go ahead and restrict it because Bruh 
...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "IGNITE-10"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_ignitebomb.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_ignitebomb.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("ignitebomb")	--NAME OF ENTITY GOES HERE

SWEP.Velocity = 1200 -- Entity Velocity
SWEP.Velocity_Underhand = 800 -- Entity Velocity
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ignitebomb")
