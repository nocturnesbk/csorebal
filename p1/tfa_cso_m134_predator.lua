--redund-- oh its the fucking minigun lmfaoo nvm
--restricted
...
SWEP.PrintName				= "M134 Predator"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m134_predator.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m134ex.mdl" -- same case UHGI;DFSD/
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m134_predator")
