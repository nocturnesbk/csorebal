...
SWEP.PrintName				= "M134 X-Mas"		-- Weapon name (Shown on HUD)
...
SWEP.MoveSpeed = 0.55 --Multiply the player's movespeed by this.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_m134_xmas.mdl" --Viewmodel path
...
SWEP.ViewModelBoneMods = {
    ["Bone_R_Upper"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(-100, 0, 0) }
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_m134_xmas.mdl" -- same case UHGI;DFSD/
...
SWEP.RunSightsPos = Vector(0, -18, -5)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m134_xmas")
