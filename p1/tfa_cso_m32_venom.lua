...
SWEP.PrintName				= "M32 MGL Venom"		-- Weapon name (Shown on HUD)
...
SWEP.Type	= "Common Grade Grenade Launcher"
...
--Firing related
SWEP.Primary.Sound 			= Sound("M32Venom.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Milked M32 Gasbomber"
...
SWEP.Primary.SpreadMultiplierMax = 1.75 --How far the spread can expand when you shoot.
...
SWEP.ProjectileEntity = "m32_venom_nade" --Entity to shoot
SWEP.ProjectileVelocity = 2400 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_shell_svdex.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_m32_venom.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_m32_venom.mdl" -- Weapon world model path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_m32_venom")
