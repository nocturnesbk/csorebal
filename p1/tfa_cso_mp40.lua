...
SWEP.Primary.DefaultClip			= 192				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
--Recoil Related
SWEP.Primary.KickUp			= 0.11 				-- This is the maximum upwards recoil (rise)
