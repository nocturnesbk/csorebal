...
///SWEP.Secondary.Sound = Sound("OICW.Fire_Nade") --Firing sound
///SWEP.Secondary.Recoil = Angle(-5,1,0) --Recoil Dir

SWEP.Secondary.ClipSize = -1
SWEP.Secondary.DefaultClip = 6
SWEP.Secondary.Ammo = "smg1_grenade"
SWEP.Secondary.Sound = Sound("OICW.Fire_Nade")

SWEP.Secondary.Projectile = "oicw_nade"
SWEP.Secondary.ProjectileModel = "models/weapons/tfa_cso/w_shell_svdex.mdl"
SWEP.Secondary.ProjectileVelocity = 1500
...
SWEP.Primary.Spread		= .00584					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .00292	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.IronSightsPos = Vector(8.9, -2.512, 2.5)
SWEP.IronSightsAng = Vector(-2, 6.5, -1)
