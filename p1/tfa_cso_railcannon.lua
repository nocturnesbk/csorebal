...
SWEP.Attachments = {
    [1] = { atts = { "cso_railcannonhalloween","cso_railcannondragonknight" } },
}
...
SWEP.StatCache_Blacklist = {
	["Primary.Damage"] = true -- allow damage changes
}
...
function SWEP:Think2(...)
	...
	local c = self:GetCharge()
	self.Primary_TFA.Damage = self.Primary.DamageChargeTable[math.Clamp(c, 0, 3)]
