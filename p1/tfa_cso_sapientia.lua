...
SWEP.DamageType = bit.bor(DMG_BULLET,DMG_BLAST,DMG_BURN) --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
...
SWEP.IronSightsPos = Vector(4.325, -2, 1.68)
SWEP.IronSightsAng = Vector(0.65, -1.6, -2.85)
...
SWEP.Primary.ImpactEffect = "exp_sapientia"
