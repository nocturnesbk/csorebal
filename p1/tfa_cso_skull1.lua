...
SWEP.Primary.SpreadIncrement = 3.75 --What percentage of the modifier is added on, per shot.
SWEP.Primary.SpreadRecovery = 4.25 --How much the spread recovers, per second.
...
function SWEP:Initialize()
    ...
    self.StatCache_Blacklist["Primary.RPM_Semi"] = true
	...
	self.StatCache_Blacklist["Secondary.Automatic"] = true
    self:ClearStatCache()
end
