...
SWEP.RunSightsPos = Vector(-2.288, -7.009, 1)
SWEP.RunSightsAng = Vector(-30.223, -46.562, 15)
...
SWEP.Secondary.BashDelay = 0.85
SWEP.Secondary.BashDamage = 375
SWEP.Secondary.BashLength = 115

SWEP.Secondary.BashSound = Sound("common/null.wav")
SWEP.Secondary.BashHitSound = Sound("SKULL9.HitWorld")
SWEP.Secondary.BashHitSound_Flesh = Sound("SKULL9.HitFlesh")
