...
SWEP.IronSightsPos = Vector(6.5, 0, 2.5)
SWEP.IronSightsAng = Vector(-0.875, -0.675, -3.152)
...
SWEP.BlowbackVector = Vector(0.015,-3,-0.06) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.BlowbackBoneMods = {
	["TAR-21_load02"] = { scale = Vector(1, 1, 1), pos = Vector(0, -6, 0), angle = Angle(0, 0, 0) },
}
