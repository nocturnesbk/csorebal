...
SWEP.Purpose				= "This gun's secondary mode fires explosive cluster-grenades." --Purpose Tooltip
...
SWEP.Primary.Spread		= .0058					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .0029	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_thanatos5.mdl" --Viewmodel path
...
SWEP.Secondary.Ammo = "Thanatos5_Grenade"
SWEP.Secondary.Ent = "thanatos5_nade_spawn"
SWEP.Secondary.Automatic = true
SWEP.Secondary.Model = "models/weapons/tfa_cso/thanatos5_nade.mdl" --Projectile Model
SWEP.Secondary.Damage = 300 --Grenade Damage
SWEP.Secondary.Velocity = 1000 --Grenade Velocity
SWEP.Secondary.Delay = 2 --Delay in seconds
SWEP.Secondary.Sound = Sound("Thanatos5.Fire2") --Firing sound
...
function SWEP:Think() 
if SERVER then
if self:GetSilenced() and self.Secondary.Nextregen <= CurTime()  and self:Ammo2() == 0 then 
self.Owner:GiveAmmo( 1,"Thanatos5_Grenade", true )                     -------SECONDARY AMMO REGEN
self.Secondary.Nextregen =  CurTime()  + 2   ---2 seconds
end
end
