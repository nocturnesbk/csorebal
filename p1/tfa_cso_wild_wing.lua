...
SWEP.PrintName				= "Wild Wing"		-- Weapon name (Shown on HUD)
...
SWEP.ProjectileEntity = "cso_wildwing_ball" --Entity to shoot
SWEP.ProjectileVelocity = 2500 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_catapult_ball.mdl" --Entity to shoot's model
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_wild_wing.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_wild_wing.mdl" -- Weapon world model path
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_wild_wing")
