...
SWEP.PrintName				= "AK-47 60R Classic Expert"		-- Weapon name (Shown on HUD)
...
SWEP.NZPaPName				= "Soviet Banana"
SWEP.NZPaPReplacement 	= "tfa_cso_ak713_v8"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.Primary.DefaultClip			= 370				-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ak4713_v6.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ak4713_v6.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ak4713_v6")
