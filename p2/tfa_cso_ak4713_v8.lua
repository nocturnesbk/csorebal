...
SWEP.PrintName				= "AK-47 60R Classic Master"		-- Weapon name (Shown on HUD)
...
--SWEP.NZPaPReplacement 	= "tfa_cso_ak713_v6"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ak4713_v8.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ak4713_v8.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ak4713_v8")
