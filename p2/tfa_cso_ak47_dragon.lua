...
SWEP.PrintName				= "AK-47 Dragon"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ak47Dragon.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ak47_dragon.mdl" -- Worldmodel path
