...
SWEP.PrintName				= "AK-47 Camouflage"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ak47_hq.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ak47_hq.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.67, -4.114, 3)
SWEP.IronSightsAng = Vector(0.35, -0.035, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ak47_hq")
