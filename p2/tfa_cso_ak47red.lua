...
SWEP.PrintName				= "AK-47 Red"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ak47red.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ak47red.mdl" -- Worldmodel path
