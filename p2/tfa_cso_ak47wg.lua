...
SWEP.PrintName				= "AK-47 White Gold"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ak47wg.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ak47wg.mdl" -- Worldmodel path
