...
SWEP.PrintName				= "Beretta ARX-160"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_arx160.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_arx160.mdl" -- Worldmodel path
