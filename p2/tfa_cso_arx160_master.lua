...
SWEP.PrintName				= "Beretta ARX-160 Master"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.RPM				= 725					-- This is in Rounds Per Minute / RPM
SWEP.Primary.RPM_Semi				= 725					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_arx160_master.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_arx160_master.mdl" -- Worldmodel path
