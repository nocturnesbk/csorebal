...
SWEP.PrintName				= "AutoMag V"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("AUTOMAG.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.SpreadRecovery = 3.75 --How much the spread recovers, per second.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_automagv.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_automaghalloween" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_automagv.mdl" -- Worldmodel path
