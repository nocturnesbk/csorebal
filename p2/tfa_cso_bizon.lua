...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_bizon.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_bizonsummer" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_bizon.mdl" -- Worldmodel path
