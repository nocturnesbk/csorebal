...
SWEP.PrintName				= "Battle Colt Python"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.SpreadRecovery = 3.25 --How much the spread recovers, per second.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_bpython.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_bpython.mdl" -- same case UHGI;DFSD/
...
SWEP.IronSightsPos = Vector(4.25, -2, 1.55)
SWEP.IronSightsAng = Vector(1, -1.825, -3)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_bpython")
