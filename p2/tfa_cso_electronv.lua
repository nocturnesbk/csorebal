...
SWEP.PrintName				= "Electron-V"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("ElectronV.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Secondary.Ammo = "electronv_alt"
SWEP.Secondary.Ent = "lightningar"
...
SWEP.Secondary.Sound = Sound("ElectronV.Fire3") --Firing sound
...
SWEP.Primary.Spread		= .003					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_electronv.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_electronv.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_electronv")
	SWEP.DrawWeaponSelection = TFA_CSO_DrawWeaponSelection
end

DEFINE_BASECLASS(SWEP.Base)
function SWEP:Holster( ... )
	self:StopSound("ElectronV.Idle1")
	self:StopSound("ElectronV.Idle2")
	self:StopSound("ElectronV.Idle3")
...
function SWEP:PostPrimaryAttack()
    if SERVER then
        ...
        if self.NextGen >= 8 and self:Ammo2() < 3 then
