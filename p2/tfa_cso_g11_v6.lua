...
SWEP.Primary.RPM_Burst				= 2062.5					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_g11_v6")
