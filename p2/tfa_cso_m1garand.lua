...
SWEP.IronSightsPos = Vector(0, -6, 1.075)
SWEP.IronSightsAng = Vector(0.3, -0.075, 0)

SWEP.Sights_Mode = TFA.Enum.LOCOMOTION_HYBRID -- LOCOMOTION_ANI = mdl, LOCOMOTION_HYBRID = ani + lua, LOCOMOTION_LUA = lua only
SWEP.IronAnimation = {
	["in"] = {
		["type"] = TFA.Enum.ANIMATION_SEQ, -- Sequence or act
		["value"] = "change1", -- Number for act, String/Number for sequence
		["value_empty"] = "change1_empty",
		["transition"] = true
	}, -- Inward transition
	["loop"] = {
		["type"] = TFA.Enum.ANIMATION_SEQ, -- Sequence or act
		["value"] = "idleB", -- Number for act, String/Number for sequence
		["value_empty"] = "idleB_empty",
	}, -- Looping Animation
	["out"] = {
		["type"] = TFA.Enum.ANIMATION_SEQ, -- Sequence or act
		["value"] = "change2", -- Number for act, String/Number for sequence
		["value_empty"] = "change2_empty",
		["transition"] = true
	}, -- Outward transition
	["shoot"] = {
		["type"] = TFA.Enum.ANIMATION_SEQ, -- Sequence or act
		["value"] = "shootB", -- Number for act, String/Number for sequence
		["value_last"] = "shootB_empty"
	} -- What do you think
}
