...
SWEP.InspectPos = Vector(-7.5, -7.5, -2) --Replace with a vector, in style of ironsights position, to be used for inspection
SWEP.InspectAng = Vector(25, -55, -10) --Replace with a vector, in style of ironsights angle, to be used for inspection
