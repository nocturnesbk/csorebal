...
SWEP.Primary.Damage_Secondary		= 650					-- Damage, in standard damage points.
...
SWEP.Primary.ImpactEffect = "exp_scsr"
...
self.Primary_TFA.Sound = Sound("StarAR.Fire2")
...
self.Primary_TFA.Sound = Sound("StarAR.Fire")
self.Primary_TFA.Damage = self.Primary.Damage_Regular
self.Primary_TFA.DamageType = bit.bor(DMG_BULLET,DMG_DISSOLVE)
self.TracerName = "cso_tra_scsr"
end
...
if self:Clip1() == 0 or self:Clip1() == 34 then
self.Primary_TFA.Sound = Sound("StarAR.Fire")
self.Primary_TFA.Damage = self.Primary.Damage_Regular
self.Primary_TFA.DamageType = bit.bor(DMG_BULLET,DMG_DISSOLVE)
self.TracerName = "cso_tra_scsr"
