...
SWEP.PrintName				= "M136 AT4 CS"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("AT4.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ProjectileEntity = "at4ex_rocket" --Entity to shoot
SWEP.ProjectileVelocity = 35000 --Entity to shoot's velocity
SWEP.ProjectileModel = "models/weapons/tfa_cso/w_at4_rocket.mdl" --Entity to shoot's model

--[[VIEWMODEL]]--

SWEP.ViewModel			= "models/weapons/tfa_cso/c_at4ex.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_at4ex.mdl" -- Weapon world model path
