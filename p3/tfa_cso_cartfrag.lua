...
SWEP.Purpose				= ""
SWEP.Instructions				= ""
SWEP.PrintName				= "Dao Grenade"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel				= "models/weapons/tfa_cso/c_cartfrag.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_cso/w_cartfrag.mdl"	-- Weapon world model
...
SWEP.Primary.Round 			= ("cartfrag")	--NAME OF ENTITY GOES HERE

SWEP.Velocity = 800 -- Entity Velocity
SWEP.Velocity_Underhand = 400 -- Entity Velocity
