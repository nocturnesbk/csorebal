...
--Firing related
SWEP.Primary.Sound 			= Sound("Famas.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "Frenchie Run Away"
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_famas.mdl" --Viewmodel path
...
SWEP.Attachments = {
    [1] = { atts = { "cso_famas_snowflake" } },
}

--[[WORLDMODEL]]--

SWEP.WorldModel			= "models/weapons/tfa_cso/w_famas.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_famas")
