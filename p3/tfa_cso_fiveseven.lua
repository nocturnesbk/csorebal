...
SWEP.PrintName				= "FN Five-seveN"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Fiveseven.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_fiveseven.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_fiveseven.mdl" -- same case UHGI;DFSD/
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_fiveseven")
