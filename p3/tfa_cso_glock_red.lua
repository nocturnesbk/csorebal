...
SWEP.Primary.RPM_Burst				= 2400					-- RPM for semi-automatic or burst fire.  This is in Rounds Per Minute / RPM
...
--Recoil Related
SWEP.Primary.KickUp			= 0.095				-- This is the maximum upwards recoil (rise)
...
SWEP.Primary.Spread		= .0028					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
