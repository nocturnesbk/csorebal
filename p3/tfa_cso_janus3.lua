...
SWEP.Purpose				= "Firing this weapon builds a secondary charge. Once you've fired 25 or more times, right-click to activate JANUS mode. Fire indefinitely until 7 seconds pass." --Purpose Tooltip
SWEP.Instructions				= "" --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.PrintName				= "JANUS-3"		-- Weapon name (Shown on HUD)
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_janus3.mdl" --Viewmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_janus3")
...
function SWEP:SecondaryAttack()
	if self:Ammo2() < 100 then return end
...
SWEP.Secondary.Ammo			= "janus_3" -- Self explanitory, ammo type.

function SWEP:PostPrimaryAttack()
self.NextGen = self.NextGen +1
if SERVER then
if self.NextGen >= 1 and not self:GetSilenced() and self:Ammo2() < 100 then
...
if self:Ammo2() == 100 and self.NextGen == 0 then
