...
sound.Add({
	['name'] = "JayDagger.Draw",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/jaydagger/draw.wav" },
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "JayDagger.Midslash1",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/jaydagger/midslash1.wav"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "JayDagger.Midslash2",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/jaydagger/midslash2.wav"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "JayDagger.Stab",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/jaydagger/stab.wav"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "JayDagger.HitFleshSlash1",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/jaydagger/hit1.wav"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "JayDagger.HitFleshSlash2",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/jaydagger/hit2.wav"},
	['pitch'] = {100,100}
})
...
sound.Add({
	...
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/jaydagger/hit3.wav"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "JayDagger.HitWall",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/jaydagger/wall.wav" },
	['pitch'] = {100,100}
})
