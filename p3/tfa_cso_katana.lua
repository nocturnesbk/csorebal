...
sound.Add({
	['name'] = "Katana.Draw",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/katana/draw.wav" },
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "Katana.Slash1",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/katana/slash1.wav"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "Katana.Slash2",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/katana/slash2.wav"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "Katana.Stab",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/katana/stab.wav"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "Katana.HitFleshSlash1",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/katana/hit.wav"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "Katana.HitWall",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/katana/wall.wav" },
	['pitch'] = {100,100}
})
