...
SWEP.Primary.Damage_Secondary		= 540				-- Damage, in standard damage points.
...
SWEP.Attachments = {
    [1] = { atts = { "cso_m249phoenixpaintiron" } },
}
...
SWEP.RunSightsPos = Vector(-3.788, -3.009, 0)
SWEP.RunSightsAng = Vector(-10.223, -30.562, 0)
...
SWEP.MuzzleFlashEffect = "cso_muz_m249phoenix" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.

--Tracer Stuff

SWEP.Tracer				= 0		--Bullet tracer.  TracerName overrides this.
SWEP.TracerName 		= "cso_tra_m249phoenix" 	--Change to a string of your tracer name.  Can be custom.
...
function SWEP:Think2(...)
	...
	elseif self:GetIronSightsProgress() > 0.5 and not self:GetCSO_SwitchState() then
		self.TracerName = "tra_m249phoenix"
