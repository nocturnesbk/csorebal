...
SWEP.Secondary.Ammo = "white_tiger"
...
SWEP.VElements = {
    ["eye"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "tiger_root", rel = "", pos = Vector(0.1, -1.8, -2.8), angle = Angle(0, 150, 90), size = Vector(0.1, 0.1, 0.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "sprites/m95_white_tiger_eye", skin = 0, bodygroup = {} }
}
