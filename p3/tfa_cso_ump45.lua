...
--Firing related
SWEP.Primary.Sound 			= Sound("Ump45.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_ump45.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_ump45.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(8.472, -4.114, 2.5)
SWEP.IronSightsAng = Vector(2.065, -0.102, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ump45")
