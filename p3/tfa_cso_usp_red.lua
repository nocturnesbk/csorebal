...
SWEP.WElements = {
    ["silencer"] = { type = "Model", model = "models/weapons/tfa_cso/w_uspred_silencer.mdl", bone = "models/weapons/tfa_cso/w_usp.mdl", rel = "", pos = Vector(0, 8.35, 0.85), angle = Angle(0, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false }
}
