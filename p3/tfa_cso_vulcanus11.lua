...
SWEP.Primary.SilencedSound = Sound("Vulcanus11.Fire2") -- This is the sound of the weapon, when silenced.
...
function SWEP:Think2(...)
	if self:GetStatus() == TFA.Enum.STATUS_SILENCER_TOGGLE and self:GetStatusEnd() <= CurTime() then
		...
		if self:GetSilenced() then
            ...
            self.Primary_TFA.KickHorizontal = 0.16
			self.Primary_TFA.Spread = .045
