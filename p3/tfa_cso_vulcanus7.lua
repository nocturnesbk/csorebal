...
SWEP.Primary.Spread		= .0045				--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .00225	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.Secondary.MaxAmmo = 5
SWEP.Secondary.Ammo = "missile_vulcanus7"
...
SWEP.Secondary.Delay = 1.5 --Delay in seconds
SWEP.Secondary.Sound = Sound("Vulcanus7.FireB") --Firing sound
...
if SERVER then
if self:Clip1() == 111 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 3
self.TracerName = "cso_tra_janus11b"
end
if self:Clip1() == 110 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 1
self.TracerName = nil
self:SendViewModelAnim(ACT_VM_SECONDARYATTACK)
self:EmitSound("Vulcanus7.Fire2")
end
if self:Clip1() == 101 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 3
self.TracerName = "cso_tra_janus11b"
end
if self:Clip1() == 100 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 1
self.TracerName = nil
self:SendViewModelAnim(ACT_VM_SECONDARYATTACK)
...
if self:Clip1() == 91 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 3
self.TracerName = "cso_tra_janus11b"
end
if self:Clip1() == 90 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 1
self.TracerName = nil
self:SendViewModelAnim(ACT_VM_SECONDARYATTACK)
...
if self:Clip1() == 81 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 3
self.TracerName = "cso_tra_janus11b"
end
if self:Clip1() == 80 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 1
self.TracerName = nil
self:SendViewModelAnim(ACT_VM_SECONDARYATTACK)
...
if self:Clip1() == 71 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 3
self.TracerName = "cso_tra_janus11b"
end
if self:Clip1() == 70 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 1
self.TracerName = nil
self:SendViewModelAnim(ACT_VM_SECONDARYATTACK)
...
if self:Clip1() == 61 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 3
self.TracerName = "cso_tra_janus11b"
end
if self:Clip1() == 60 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 1
self.TracerName = nil
self:SendViewModelAnim(ACT_VM_SECONDARYATTACK)
...
if self:Clip1() == 51 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 3
self.TracerName = "cso_tra_janus11b"
end
if self:Clip1() == 50 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 1
self.TracerName = nil
self:SendViewModelAnim(ACT_VM_SECONDARYATTACK)
...
if self:Clip1() == 41 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 3
self.TracerName = "cso_tra_janus11b"
end
if self:Clip1() == 40 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 1
self.TracerName = nil
self:SendViewModelAnim(ACT_VM_SECONDARYATTACK)
...
if self:Clip1() == 31 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 3
self.TracerName = "cso_tra_janus11b"
end
if self:Clip1() == 30 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 1
self.TracerName = nil
self:SendViewModelAnim(ACT_VM_SECONDARYATTACK)
...
if self:Clip1() == 21 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 3
self.TracerName = "cso_tra_janus11b"
end
if self:Clip1() == 20 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 1
self.TracerName = nil
self:SendViewModelAnim(ACT_VM_SECONDARYATTACK)
...
if self:Clip1() == 11 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 3
self.TracerName = "cso_tra_janus11b"
end
if self:Clip1() == 10 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 1
self.TracerName = nil
self:SendViewModelAnim(ACT_VM_SECONDARYATTACK)
...
if self:Clip1() == 1 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 3
self.TracerName = "cso_tra_janus11b"
end
if self:Clip1() == 0 and self:GetSilenced() then
self.Primary_TFA.Damage = 36
self.Primary_TFA.NumShots = 1
self.TracerName = nil
self:SendViewModelAnim(ACT_VM_SECONDARYATTACK)
