...
SWEP.PrintName = "Slasher"
SWEP.Type	= "Rare Grade Equipment"
SWEP.ViewModel = "models/weapons/tfa_cso/c_chainsawm.mdl"
...
SWEP.WorldModel = "models/weapons/tfa_cso/w_chainsawm.mdl"
SWEP.Offset = {
	Pos = {
		Up = 1,
		Right = 1.5,
...
function SWEP:Saw( damage, force, reach )
	...
	if slashtrace.Hit then
		if game.GetTimeScale() > 0.99 then
			...
			dmg:SetDamageForce(self.Owner:GetAimVector() * (46))
			dmg:SetDamage(50)
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_chainsawm")
