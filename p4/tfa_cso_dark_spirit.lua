...
function SWEP:Reload(...)
	...
	timer.Simple( 0.75, function()
		if self:IsValid() then
			...
			-- 	end
			-- end
				local dmginfo = CSO:DMGInfo(self.Owner, self, 4000, Vector(0,0,0), DMG_BLAST, self:GetPos())
				CSO:DoRadiusAttack(self, dmginfo, 225, true, 2048, 2, false, nil, true)
			end
...
--  hook.Add( "PlayerShouldTakeDamage", "antiselfdamage_darkspirit", function( ply, attacker )
