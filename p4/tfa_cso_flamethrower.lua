...
SWEP.PrintName				= "Salamander"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Range = 10 * 40 --Flame Distance
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_cso/c_flamethrower.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_cso/w_flamethrower.mdl" -- Weapon world model path
...
local function cb( a, b, c )
	...
	if IsValid(b.Entity) and b.Entity.Ignite and not b.Entity:IsWorld() then
		b.Entity:Ignite( c:GetDamage(), 25 )
	end
end
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_flamethrower")
