...
SWEP.PrintName = "Hauteclere"
SWEP.Author	= "Kamikaze, Meika, ★Bullet★" --Author Tooltip
SWEP.Purpose = "An unordinary sword inspired by Gilgamesh? Sword Bombardment = RMB > LMB > LMB > RMB > LMB" --Purpose Tooltip
SWEP.Type	= "Melee weapon"
SWEP.ViewModel = "models/weapons/tfa_cso/c_hauteclere.mdl"
SWEP.WorldModel = "models/weapons/tfa_cso/w_hauteclere.mdl"
...
sound.Add({
	['name'] = "Hauteclere.Draw",
	['channel'] = CHAN_WEAPON,
	['sound'] = { "weapons/tfa_cso/hauteclere/draw.wav" },
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "Hauteclere.Slash1",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/hauteclere/slash1.wav"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "Hauteclere.Slash2",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/hauteclere/slash2.wav"},
	['pitch'] = {100,100}
})
sound.Add({
	['name'] = "Hauteclere.Slash_B",
	['channel'] = CHAN_STATIC,
	['sound'] = { "weapons/tfa_cso/hauteclere/slashb.wav"},
	['pitch'] = {100,100}
})
sound.Add({
...
SWEP.Secondary.Attacks = {
	{
		...
		['dir'] = Vector(65,0,-85), -- Trace dir/length; X ( +right, -left ), Y ( +forward, -back ), Z ( +up, -down )
...
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_hauteclere")
