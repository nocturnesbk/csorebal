...
SWEP.Author				= "Kamikaze, ★Bullet★, Meika" --Author Tooltip
SWEP.Contact				= "" --Contact Info Tooltip
SWEP.Purpose				= "" --Purpose Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.PrintName				= "Heaven Splitter"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.BlastRadius	= 128               -- Radius for DMG_BLAST
...
SWEP.VElements = {
    ["glow_1"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "Bone_epic_root", rel = "", pos = Vector(13, -0.10, 1.75), angle = Angle(0, 90, -25), size = Vector(0.0725, 0.0725, 0.0001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "sprites/heavenscorcher_mine_set", skin = 0, bodygroup = {} },
    ["glow_2"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "Bone_epic_root", rel = "", pos = Vector(11.8, -0.10, 1.75), angle = Angle(0, 90, -25), size = Vector(0.0725, 0.0725, 0.0001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "sprites/heavenscorcher_mine_set", skin = 0, bodygroup = {} },
    ["glow_3"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "Bone_epic_root", rel = "", pos = Vector(10.7, -0.10, 1.75), angle = Angle(0, 90, -25), size = Vector(0.0725, 0.0725, 0.0001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "sprites/heavenscorcher_mine_set", skin = 0, bodygroup = {} },
    ["glow_4"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "Bone_epic_root", rel = "", pos = Vector(9.55, -0.10, 1.75), angle = Angle(0, 90, -25), size = Vector(0.0725, 0.0725, 0.0001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "sprites/heavenscorcher_mine_set", skin = 0, bodygroup = {} }
}
...
SWEP.MuzzleFlashEffect = "cso_muz_heavenscorcher" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
