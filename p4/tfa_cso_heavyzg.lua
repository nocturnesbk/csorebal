...
SWEP.PrintName				= "Lightning HZ-1"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("HeavyZG.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_heavyzg.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_heavyzg.mdl" -- Worldmodel path
...
SWEP.IronSightsPos = Vector(7.386, -2.0, 1.9)
SWEP.IronSightsAng = Vector(1.5, 0.05, 0)
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_heavyzg")
