...
SWEP.VElements = {
	...
	["smoke_left"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "bone_gill02", rel = "", pos = Vector(-5, 2.5, 3), angle = Angle(0, 0, -20), size = Vector(0.25, 0.25, 0.25), color = Color(255, 255, 255, 255), surpresslightning = false, material = "sprites/m3shark_smoke", skin = 0, bodygroup = {} }
}
...
SWEP.IronSightsPos = Vector(15.519, 0, -1.601)
