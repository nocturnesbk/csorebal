...
SWEP.Secondary.Ammo = "ghost_knight"
...
SWEP.VElements = {
    ["eye"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "tigerm_root", rel = "", pos = Vector(0.0, -1.4, -2.8), angle = Angle(5, 170, 85), size = Vector(0.2, 0.35, 0.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "sprites/m95ghost_eye", skin = 0, bodygroup = {} }
}
