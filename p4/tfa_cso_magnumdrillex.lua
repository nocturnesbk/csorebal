...
SWEP.PrintName				= "Gigantic Drill"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("Magnumdrillex.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_magnumdrillex.mdl" --Viewmodel path
...
///SWEP.VElements = {
///    ["smoke"] = { type = "Model", model = "models/hunter/plates/plate1x1.mdl", bone = "smoke_bone", rel = "", pos = Vector(1.1, -0, -3), angle = Angle(15, 90, 100), size = Vector(0.1, 0.15, 0.0001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "sprites/ef_sgdrillex_smoke", skin = 0, bodygroup = {} }
///}
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_magnumdrillex.mdl" -- Worldmodel path
...
SWEP.MuzzleFlashEffect = "cso_muz_magnumdrillex" --Change to a string of your muzzle flash effect.  Copy/paste one of the existing from the base.
...
SWEP.Secondary.BashDelay = 0.6
SWEP.Secondary.BashDamage = 4500
...
function SWEP:Holster( ... )
	self:StopSound("Magnumdrillex.Idle1")
	return BaseClass.Holster(self,...)
end

SWEP.Base				= "tfa_bash_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_magnumdrillex")
