...
SWEP.PrintName				= "Mechasaurus MK-2"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("MechasaurusMK.Fire1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "DINO-5 (Take 2)"
SWEP.NZPaPReplacement 	= "tfa_cso_mechasaurus_mk2"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mechasaurus_mk2.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mechasaurus_mk2.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mechasaurus_mk2")
