...
SWEP.Purpose				= "Firing this weapon builds a secondary charge. Once you've fired 25 or more times, right-click to activate Transform System. You'll fire faster and deal more damage." --Purpose Tooltip
SWEP.Instructions				= "" --Instructions Tooltip
SWEP.Spawnable				= true --Can you, as a normal user, spawn this?
SWEP.AdminSpawnable			= true --Can an adminstrator spawn this?  Does not tie into your admin mod necessarily, unless its coded to allow for GMod's default ranks somewhere in its code.  Evolve and ULX should work, but try to use weapon restriction rather than these.
SWEP.DrawCrosshair			= true		-- Draw the crosshair?
SWEP.PrintName				= "Mechasaurus MK-3"		-- Weapon name (Shown on HUD)	
...
SWEP.NZPaPName				= "Jurassic-5"
SWEP.NZPaPReplacement 	= "tfa_cso_mechasaurus_mk4"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_mechasaurus_mk3.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_mechasaurus_mk3.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mechasaurus_mk3")
...
SWEP.Secondary.Ammo			= "mecha_mk3" -- Self explanitory, ammo type.
