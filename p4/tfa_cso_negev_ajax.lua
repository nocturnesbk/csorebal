...
SWEP.Primary.BlastRadius	= 5              -- Radius for DMG_BLAST
...
SWEP.VMPos = Vector(-2.5,1,-0.2) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.RunSightsAng = Vector(-12.223, -25.562, 0)
