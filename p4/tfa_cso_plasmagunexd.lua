...
SWEP.Primary.SilencedSound	= Sound("TiamatMK4.Fire3")				-- This is the sound of the weapon, when you shoot.
...
SWEP.Secondary.Damage = 1500 --Grenade Damage
SWEP.Secondary.Velocity = 9750 --Grenade Velocity
...
function SWEP:Think2(...)
	if self:GetStatus() == TFA.Enum.STATUS_SILENCER_TOGGLE and self:GetStatusEnd() <= CurTime() then
		...
		self.Primary_TFA.Sound = Sound("TiamatMK4.Fire")
		self.Primary_TFA.AmmoConsumption = 1
		self.Primary_TFA.Projectile = "plasmaexd"
		self.Primary_TFA.ProjectileVelocity = 6500
		self:ClearStatCache()
		else
		self.Primary_TFA.Sound = Sound("TiamatMK4.Fire3")
		self.Primary_TFA.AmmoConsumption = 1
		self.Primary_TFA.Projectile = "plasmaex"
		self.Primary_TFA.ProjectileVelocity = 9750
		self:ClearStatCache()
		end
	end
