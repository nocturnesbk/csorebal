...
SWEP.PrintName				= "SCAR OZ-A"		-- Weapon name (Shown on HUD)
...
--Firing related
SWEP.Primary.Sound 			= Sound("ScarA.Fire")				-- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName				= "OOF-10"
SWEP.NZPaPReplacement 	= "tfa_cso_scar_ozb"	-- If Pack-a-Punched, replace this gun with the entity class shown here.
...
SWEP.ViewModel			= "models/weapons/tfa_cso/c_scar_oza.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/weapons/tfa_cso/w_scar_oza.mdl" -- Worldmodel path
...
SWEP.Base				= "tfa_gun_base"
if CLIENT then
	SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_ozscara")
