...
SWEP.Secondary.Ammo = "oz_grenade"
...
SWEP.Secondary.Velocity = 2400 --Grenade Velocity
...
function SWEP:Think()
    if SERVER then
        if self.NextGen <= CurTime() and self:Ammo2() < 10 then
        end
    end
...
function SWEP:PostPrimaryAttack()
    if SERVER then
        ...
        if self.NextGen >= 15 and self:Ammo2() < 10 then
